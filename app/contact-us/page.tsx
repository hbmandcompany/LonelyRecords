...
export const metadata: Metadata = {
  title: "Contact Us — Lonely Records",
  description:
    "Contact Lonely Records — general inquiries, press, and partnerships.",
};
...
export default function ContactUsPage() {
  return (
    <>
      <PageBanner
        title="CONTACT US"
        subtitle="We read every message. Reach out anytime."
      />
      ...
      <section className="bg-paper px-6 pb-24 pt-6 md:px-12">
        <div className="mx-auto grid max-w-6xl gap-12 lg:grid-cols-[1fr_1.2fr] lg:items-start">
          <Reveal>
            ...
            <h2 className="font-display text-4xl tracking-[0.08em] text-ghost md:text-5xl">
              Drop Us A Line
            </h2>
            <p className="mt-6 font-mono text-sm leading-relaxed text-ink/60">
              Whether you&apos;re an artist, a journalist, or a listener with a
              question — we&apos;d love to hear from you. Use the form or email
              us directly.
            </p>
