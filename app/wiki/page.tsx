...
export const metadata: Metadata = {
  title: "Wiki — Lonely Records",
  description: "Everything you need to know about Lonely Records — history, mission, and label lore.",
};
...
const LORE = [
  ...
  { label: "Genre Focus", value: "Indie Pop, Bedroom Pop, Dream Pop" },
  { label: "HQ", value: "Basement, undisclosed" },
  { label: "Physical Formats", value: "Vinyl, Cassette, Zine" },
];
    ...
    <>
      <section className="relative overflow-hidden bg-paper px-6 pb-24 pt-36 md:px-12 md:pb-32 md:pt-44">
        <div className="mx-auto grid max-w-6xl gap-12 md:grid-cols-[1.5fr_1fr] md:items-start">
          ...
          <Reveal delay={0.1}>
            <div className="sticker space-y-0 overflow-hidden rounded-2xl bg-paper">
              <p className="border-b-[3px] border-ink bg-pink px-4 py-3 font-mono text-xs uppercase tracking-[0.2em] text-ghost">
                Quick Facts
              </p>
              {LORE.map((item) => (
                <div
                  key={item.label}
                  className="flex justify-between gap-4 border-b border-ink/10 px-4 py-3 last:border-b-0"
                >
            ...
            <div className="mt-6 flex justify-center md:justify-end">
              <Badge rotate={-12} variant="star" className="px-8 py-6 text-2xl md:text-3xl">
                EST. 2025
              </Badge>
            </div>
          </Reveal>
